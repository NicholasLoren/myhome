...
if (isset($_POST['submit'])) {
    ...
    //order code
      $result = @ mysqli_query($conn,"SHOW TABLE STATUS LIKE  'tbl_condo_orders'");
      $data = @mysqli_fetch_assoc($result);
      $next = $data['Auto_increment'];
      $prefix = "MYHOME/CO/";
      $order_code = sprintf("%s%03s",$prefix,$next);

    $msg = mysqli_query($conn,"INSERT INTO `tbl_condo_orders`(`order_code`, `condo_code`, `order_by`, `phone`, `description`) VALUES('$order_code','$condo_id','$name','$phone','$message') ");
...
<div class="col-auto ms-auto ps-lg-0 d-none d-sm-flex"> 
    ...
    <div class="header-icon">
        ...
        <!-- end header -->
        <?php $res =  mysqli_query($conn,"SELECT * FROM tbl_condominiums WHERE condo_id = '$condo_id'");
            ...
            <div class="container">
                ...
                <div class="row align-items-center align-items-lg-end justify-content-center extra-very-small-screen g-0">
                    <div class="col-xl-7 col-lg-8 position-relative page-title-extra-small md-mb-30px md-mt-auto" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        <h3 class="alt-font fw-600 text-white mb-15px ls-minus-1px"><?php echo $row['condo_name']; ?></h3>
                ...
                <div class="row">
                    <div class="col-lg-7 md-mb-50px">
                        ...
                        <div class="row mt-7">
                            ...
                            <div class="col-xl-6">
                                <div class="row g-0 align-items-center mb-15px pb-15px border-bottom border-color-extra-medium-gray">
                                    ...
                                    <div class="col"><?php echo $row['condo_code']; ?></div>
                                </div>
                                <div class="row g-0 align-items-center mb-15px pb-15px border-bottom border-color-extra-medium-gray">
                                    <div class="col">
                                        <!-- start features box item -->
                                    ...
                                    <div class="col"><?php echo $row['condo_type']; ?></div>
                                </div>
                                <div class="row g-0 align-items-center mb-15px pb-15px border-bottom border-color-extra-medium-gray">
                                    <div class="col">
                                        <!-- start features box item -->
                        ...
                        <div class="row mt-7">
                           ...
                           <?php
                    $get_features = mysqli_query($conn,"SELECT * FROM tbl_condominium_features WHERE condo_code ='$condo_code' LIMIT 1");
                    ...
                    ?>
                       ...
                       <div class="row mt-7">
                            ...
                            <div class="col-6">
                                <span class="text-dark-gray fs-24 fw-600 alt-font mb-25px d-block">Other Views</span>
                    ...
                    <div class="col-xl-4 offset-xl-1 col-lg-5">
                        <div class="bg-base-color-light border-radius-6px position-sticky top-120px">
                            <div class="bg-base-color border-radius-6px feature-box overflow-hidden icon-with-text-style-08 ps-35px pe-35px pt-25px pb-20px xs-p-25px">
                                <!-- start features box item -->
                                <div class="feature-box-content">
                                    <span class="text-white alt-font fw-600 fs-20 ">Talk to us today about buying this condominium</span>
                                </div>
                                <!-- end features box item -->
                            </div>
                            <div class="ps-45px pe-45px pt-35px pb-45px xs-p-25px contact-form-style-01 mt-0">
                                ...
                                <form action="" method="post">
                                    <div class="position-relative form-group mb-15px">
                                        <input type="text" name="id" value="<?php echo $row['condo_code']; ?>"class="form-control border-color-white box-shadow-large required" placeholder="Apartment ID: <?php echo $row['condo_code']; ?>" disabled="disabled" />
                                    </div>
                                    <div class="position-relative form-group mb-15px">
        ...
        <section class="bg-gradient-very-light-gray">
            <div class="container">
                ...
                <div class="row row-cols-1 row-cols-xl-3 row-cols-lg-2 row-cols-md-2 justify-content-center"> 
                     <?php $res =  mysqli_query($conn,"SELECT * FROM tbl_condominiums LIMIT 3");
                        $count = mysqli_num_rows($res);
                        if($count > 0) {
                        while($row=mysqli_fetch_assoc($res)){ 
                            $apartment_id =  $row['condo_id']; ?>
