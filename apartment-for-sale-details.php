...
//sending order on apartment
if (isset($_POST['submit'])) {
    $name = $_POST['name'];
    $phone = $_POST['phone'];
    $message = $_POST['comment'];
    //order code
      $result = @ mysqli_query($conn,"SHOW TABLE STATUS LIKE  'tbl_orders'");
      $data = @mysqli_fetch_assoc($result);
      $next = $data['Auto_increment'];
      $prefix = "MYHOME/ASR/";
      $order_code = sprintf("%s%03s",$prefix,$next);

    $msg = mysqli_query($conn,"INSERT INTO `tbl_orders`(`order_code`, `apartment_code`, `order_by`, `phone`, `specifications`) VALUES('$order_code','$apartment_id','$name','$phone','$message') ");
...
<div class="col-auto ms-auto ps-lg-0 d-none d-sm-flex"> 
    ...
    <div class="header-icon">
        ...
        <!-- end header -->
        <?php $res =  mysqli_query($conn,"SELECT * FROM tbl_apartment_for_sale WHERE apartment_id = '$apartment_id'");
        // <?php $res =  mysqli_query($conn,"SELECT tbl_apartment_rentals.*,tbl_apartment_features.* FROM tbl_apartment_rentals INNER JOIN tbl_apartment_features ON tbl_apartment_rentals.apartment_id=tbl_apartment_features.apartment_id WHERE tbl_apartment_rentals.apartment_id= '$apartment_id'");
                        $count = mysqli_num_rows($res);
                        if($count > 0) {
                        while($row=mysqli_fetch_assoc($res)){
                        $apartment_code = $row['apartment_code']; ?>
        <!-- start page title -->
        <section class="cover-background page-title-big-typography ipad-top-space-margin" style="background-image: url('admin/<?php echo $row['front_view']; ?>'); background-repeat: no-repeat;">
            <div class="container">
                <font color="white"><b> 
                <div class="row align-items-center align-items-lg-end justify-content-center extra-very-small-screen g-0">
                    <div class="col-xl-7 col-lg-8 position-relative page-title-extra-small md-mb-30px md-mt-auto" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        <h3 class="alt-font fw-600 text-white mb-15px ls-minus-1px"><?php echo $row['apartment_name']; ?></h3>
                    ...
                    <div class="col-lg-3 offset-xl-2 offset-lg-1 border-start border-2 border-color-base-color ps-40px sm-ps-25px md-mb-auto">
                        <h4 class="text-white fw-700 alt-font mb-5px">Price : <?php echo $row['price']; ?></h4>
                    </div>
                </div>
            </b></font>
            </div>
                        ...
                        <div class="swiper magic-cursor slider-four-slide swiper-dark-pagination swiper-pagination-style-3" data-slider-options='{ "slidesPerView": 1, "spaceBetween": 20, "loop": true, "pagination": { "el": ".slider-four-slide-pagination", "clickable": true }, "autoplay": { "delay": 3000, "disableOnInteraction": false }, "navigation": { "nextEl": ".slider-one-slide-next-1", "prevEl": ".slider-one-slide-prev-1" }, "keyboard": { "enabled": true, "onlyInViewport": true }, "breakpoints": { "1200": { "slidesPerView": 3 }, "992": { "slidesPerView": 3 }, "768": { "slidesPerView": 2 } }, "effect": "slide" }'>
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <img src="admin/<?php echo $row['front_view']; ?>" alt="" class="w-100"  style="max-width: 500px; max-height: 316px;"/>
                                </div>
                                <!-- end content carousal item -->
                                <!-- start content carousal item -->
                                <div class="swiper-slide">
                                    <img src="admin/<?php echo $row['back_view']; ?>" alt="" class="w-100"  style="max-width: 500px; max-height: 316px;"/> 
                                </div>
                                <!-- end content carousal item -->
                                <!-- start content carousal item -->
                                <div class="swiper-slide">
                                    <img src="admin/<?php echo $row['side_view']; ?>" alt="" class="w-100"  style="max-width: 500px; max-height: 316px;"/>
                                </div>
                                <!-- end content carousal item -->
                                <!-- start content carousal item -->
                                <div class="swiper-slide">
                                    <img src="admin/<?php echo $row['aerial_view']; ?>" alt="" class="w-100"  style="max-width: 500px; max-height: 316px;"/>
                                </div>
                                <!-- end content carousal item --> 
                                <!-- start content carousal item -->
                                <div class="swiper-slide">
                                    <img src="admin/<?php echo $row['ground_floor']; ?>" alt="" class="w-100"  style="max-width: 500px; max-height: 316px;"/>
                                </div>
                                <!-- end content carousal item -->
                                <!-- start content carousal item -->
                                <div class="swiper-slide">
                                    <img src="admin/<?php echo $row['first_floor']; ?>" alt="" class="w-100"  style="max-width: 500px; max-height: 316px;"/> 
                                </div>
                                <!-- end content carousal item -->
                            </div>
            ...
            <div class="container"> 
                <div class="row row-cols-1 row-cols-lg-4 row-cols-sm-2">
                    <div class="col text-center border-end xs-border-end-0 border-color-extra-medium-gray alt-font md-mb-15px">
                        <span class="fs-19 text-dark-gray fw-600">Property size:</span> <?php echo $row['measurement']; ?>
                    </div>
                    <div class="col text-center border-end md-border-end-0 border-color-extra-medium-gray alt-font md-mb-15px">
                        <span class="fs-19 text-dark-gray fw-600">Year built:</span> <?php echo $row['year_built']; ?>
                    </div>
                    <div class="col text-center border-end xs-border-end-0 border-color-extra-medium-gray alt-font sm-mb-15px">
                        <span class="fs-19 text-dark-gray fw-600">Accommodation:</span> <?php echo $row['accomodation_type']; ?>
                    </div>
                    <div class="col text-center alt-font">
                        <span class="fs-19 text-dark-gray fw-600">Heating:</span> <?php echo $row['heating']; ?>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-lg-7 md-mb-50px">
                            ...
                            <div class="col bg-very-light-gray p-35px lg-ps-15px lg-pe-15px border-radius-6px fs-16">
                                <div class="row row-cols-2 row-cols-md-4 row-cols-sm-2">
                                    <div class="col text-center border-end border-color-extra-medium-gray sm-mb-30px">
                                        ...
                                        <span class="text-dark-gray d-block lh-20"><?php echo $row['bedrooms']; ?> Bedrooms</span>
                                    </div>
                                    <div class="col text-center border-end sm-border-end-0 border-color-extra-medium-gray sm-mb-30px">
                                        ...
                                        <span class="text-dark-gray d-block lh-20"><?php echo $row['bathrooms']; ?> Bathrooms</span>
                                    </div>
                                    <div class="col text-center border-end border-color-extra-medium-gray">
                                        ...
                                        <span class="text-dark-gray d-block lh-20"><?php echo $row['parking']; ?> Parking</span>
                                    </div>
                                    <div class="col text-center">
                                        <img src="images/demo-real-estate-icon-swimming.svg" class="w-50px mb-15px" alt="">
                                        <span class="text-dark-gray d-block lh-20">Swimming pool: <?php echo $row['swimming_pool']; ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row mt-7">
                            ...
                            <div class="col-xl-6">
                                <div class="row g-0 align-items-center mb-15px pb-15px border-bottom border-color-extra-medium-gray">
                                    ...
                                    <div class="col"><?php echo $row['apartment_code']; ?></div>
                                </div>
                                <div class="row g-0 align-items-center mb-15px pb-15px border-bottom border-color-extra-medium-gray">
                                    <div class="col">
                                        <!-- start features box item -->
                                    ...
                                    <div class="col"><?php echo $row['apartment_type']; ?></div>
                                </div>
                                <div class="row g-0 align-items-center mb-15px pb-15px border-bottom border-color-extra-medium-gray">
                                    <div class="col">
                                        <!-- start features box item -->
                                    ...
                                    <div class="col"><?php echo $row['measurement']; ?></div>
                                </div>
                                <div class="row g-0 align-items-center mb-15px pb-15px border-bottom border-color-extra-medium-gray">
                                    <div class="col">
                                        <!-- start features box item -->
                                    ...
                                    <div class="col"><?php echo $row['cooling']; ?></div>
                                </div>
                                <div class="row g-0 align-items-center lg-mb-15px lg-pb-15px lg-border-bottom border-color-extra-medium-gray">
                                    ...
                                    <div class="col"><?php echo $row['swimming_pool']; ?></div>
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="row g-0 align-items-center mb-15px pb-15px border-bottom border-color-extra-medium-gray">
                                    ...
                                    <div class="col"><?php echo $row['parking']; ?></div>
                                </div>
                                <div class="row g-0 align-items-center mb-15px pb-15px border-bottom border-color-extra-medium-gray">
                                    <div class="col">
                                        <!-- start features box item -->
                                    ...
                                    <div class="col"><?php echo $row['heating']; ?></div>
                                </div>
                                <div class="row g-0 align-items-center mb-15px pb-15px border-bottom border-color-extra-medium-gray">
                                    <div class="col">
                                        <!-- start features box item -->
                                    ...
                                    <div class="col"><?php echo $row['outdoor']; ?></div>
                                </div>
                                <div class="row g-0 align-items-center mb-15px pb-15px border-bottom border-color-extra-medium-gray">
                                    <div class="col">
                                        <!-- start features box item -->
                                    ...
                                    <div class="col"><?php echo $row['year_built']; ?></div>
                                </div>
                                <div class="row g-0 align-items-center">
                                    ...
                                    <div class="col"><?php echo $row['total_floors']; ?></div>
                                </div>
                            </div>
                        </div> 
                        <div class="row mt-7">
                        ...
                        <div class="row mt-7">
                           ...
                           <?php
                    $get_features = mysqli_query($conn,"SELECT * FROM tbl_apartment_forsale_features WHERE apartment_code ='$apartment_code' LIMIT 1");
                      $count = mysqli_num_rows($get_features);
                    if($count > 0) {
                      while($row2=mysqli_fetch_assoc($get_features)){ 
                      $refrigeratorRow = $row2['refrigerator']; 
                      $gymRow = $row2['gym']; 
                      $washerRow = $row2['washer']; 
                      $barbequeRow = $row2['barbeque']; 
                      $hangersRow = $row2['hangers']; 
                      $microwaveRow = $row2['microwave']; 
                      $saunaRow = $row2['sauna']; 
                      $dryerRow = $row2['dryer']; 
                      $laundryRow = $row2['laundry']; 
                      $showerRow = $row2['shower']; 
                      $internetRow = $row2['internet'];
                    ?>
                            <div class="col-6 col-sm-4">
                                <!-- start list style -->
                                <ul class="list-style-02 ps-0 mb-0">
                                    <?php if ($refrigeratorRow =='1') { ?>
                        ...
                        <div class="row mt-7">
                            <div class="col-6">
                                ...
                                <img src="admin/<?php echo $row['ground_floor']; ?>" class="border-radius-6px" alt="" style="max-width: 300px; max-height: 316px;">
                            </div>
                            <div class="col-6">
                                <span class="text-dark-gray fs-24 fw-600 alt-font mb-25px d-block">First floor plan</span>
                                <img src="admin/<?php echo $row['first_floor']; ?>" class="border-radius-6px" alt="" style="max-width: 300px; max-height: 316px;">
                            </div>
                        </div>
                        <div class="row mt-7">
                            <div class="col-6">
                                <span class="text-dark-gray fs-24 fw-600 alt-font mb-25px d-block">Front View</span>
                                <img src="admin/<?php echo $row['front_view']; ?>" class="border-radius-6px" alt="" style="max-width: 300px; max-height: 316px;">
                            </div>
                            <div class="col-6">
                                <span class="text-dark-gray fs-24 fw-600 alt-font mb-25px d-block">Back View</span>
                                <img src="admin/<?php echo $row['back_view']; ?>" class="border-radius-6px" alt="" style="max-width: 300px; max-height: 316px;">
                            </div>
                        </div>
                        <div class="row mt-7">
                            <div class="col-6">
                                <span class="text-dark-gray fs-24 fw-600 alt-font mb-25px d-block">Side View</span>
                                <img src="admin/<?php echo $row['side_view']; ?>" class="border-radius-6px" alt="" style="max-width: 300px; max-height: 316px;">
                            </div>
                            <div class="col-6">
                                <span class="text-dark-gray fs-24 fw-600 alt-font mb-25px d-block">Aerial View</span>
                                <img src="admin/<?php echo $row['aerial_view']; ?>" class="border-radius-6px" alt="" style="max-width: 300px; max-height: 316px;">
                            </div>
                        </div>
                        <div class="row mt-7">
                            <div class="col-12">
                                <span class="text-dark-gray fs-24 fw-600 alt-font mb-25px d-block">Tour Video</span>
                                <video width="50%" controls style="max-height: 1200px;">
          <source src="admin/<?php echo $row['tour_video']; ?>" type="video/mp4">
          <source src="admin/<?php echo $row['tour_video']; ?>" type="video/ogg"> 
                                </video>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 offset-xl-1 col-lg-5">
                        <div class="bg-base-color-light border-radius-6px position-sticky top-120px">
                            <div class="bg-base-color border-radius-6px feature-box overflow-hidden icon-with-text-style-08 ps-35px pe-35px pt-25px pb-20px xs-p-25px">
                                <!-- start features box item -->
                                <div class="feature-box-content">
                                    <span class="text-white alt-font fw-600 fs-20 ">Talk to us today about renting this apartment</span>
                                </div>
                                <!-- end features box item -->
                            </div>
                            <div class="ps-45px pe-45px pt-35px pb-45px xs-p-25px contact-form-style-01 mt-0">
                                ...
                                <form action="" method="post">
                                    <div class="position-relative form-group mb-15px">
                                        <input type="text" name="id" value="<?php echo $row['apartment_code']; ?>"class="form-control border-color-white box-shadow-large required" placeholder="Apartment ID: <?php echo $row['apartment_code']; ?>" disabled="disabled" />
                                    </div>
                                    <div class="position-relative form-group mb-15px">
        ...
        <section class="bg-gradient-very-light-gray">
            <div class="container">
                ...
                <div class="row row-cols-1 row-cols-xl-3 row-cols-lg-2 row-cols-md-2 justify-content-center"> 
                     <?php $res =  mysqli_query($conn,"SELECT * FROM tbl_apartment_for_sale LIMIT 3");
                        $count = mysqli_num_rows($res);
                        if($count > 0) {
                        while($row=mysqli_fetch_assoc($res)){ 
                        ...
                        <div class="border-radius-6px overflow-hidden box-shadow-large">
                            <div class="image position-relative">
                                <a href="apartment-for-sale-details.php?id=<?php echo $row['apartment_id']; ?>">
                                    <img src="admin/<?php echo $row['front_view']; ?>" alt="" style="max-height: 250px; max-width: 500px;">
                                </a>
            ...
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-auto d-flex flex-column flex-md-row align-items-center text-center text-md-start">
                        <div class="text-dark-gray fs-28 alt-font fw-500">1000+ apartments ready for <span class="fw-700 text-decoration-line-bottom">renting.</span></div>
