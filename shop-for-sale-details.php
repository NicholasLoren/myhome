...
if (isset($_POST['submit'])) {
    ...
    $msg = mysqli_query($conn,"INSERT INTO `tbl_shop_orders`(`order_code`, `shop_code`, `order_by`, `phone`, `specifications`) VALUES('$order_code','$shop_id','$name','$phone','$message') ");
...
<div class="col-auto ms-auto ps-lg-0 d-none d-sm-flex"> 
    ...
    <div class="header-icon">
        ...
        <!-- end header -->
        <?php $res =  mysqli_query($conn,"SELECT * FROM tbl_shop_for_sale WHERE shop_id = '$shop_id'");
            ...
            <div class="container">
                ...
                <div class="row align-items-center align-items-lg-end justify-content-center extra-very-small-screen g-0">
                    <div class="col-xl-7 col-lg-8 position-relative page-title-extra-small md-mb-30px md-mt-auto" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        <h3 class="alt-font fw-600 text-white mb-15px ls-minus-1px"><?php echo $row['shop_name']; ?></h3>
            ...
            <div class="container"> 
                <div class="row row-cols-1 row-cols-lg-4 row-cols-sm-2">
                    <div class="col text-center border-end xs-border-end-0 border-color-extra-medium-gray alt-font md-mb-15px">
                        <span class="fs-19 text-dark-gray fw-600">Shop size:</span> <?php echo $row['measurement']; ?>
                    </div>
                    ...
                    <div class="col text-center border-end xs-border-end-0 border-color-extra-medium-gray alt-font sm-mb-15px">
                        <span class="fs-19 text-dark-gray fw-600">Total Rooms:</span> <?php echo $row['total_rooms']; ?>
                    </div>
                    <div class="col text-center alt-font">
                        <span class="fs-19 text-dark-gray fw-600">Store Rooms:</span> <?php echo $row['store_room']; ?>
                    </div>
                </div>
            </div>
        </section>
                            ...
                            <div class="col bg-very-light-gray p-35px lg-ps-15px lg-pe-15px border-radius-6px fs-16">
                                <div class="row row-cols-2 row-cols-md-4 row-cols-sm-2">
                                    <div class="col text-center border-end border-color-extra-medium-gray sm-mb-30px">
                                        ...
                                        <span class="text-dark-gray d-block lh-20"><?php echo $row['total_rooms']; ?> Rooms</span>
                                    </div>
                                    <div class="col text-center border-end sm-border-end-0 border-color-extra-medium-gray sm-mb-30px">
                                        ...
                                        <span class="text-dark-gray d-block lh-20"><?php echo $row['store_room']; ?> Store Rooms</span>
                                    </div>
                                    ...
                                    <div class="col text-center">
                                        ...
                                        <span class="text-dark-gray d-block lh-20">Outdoor: <?php echo $row['outdoor']; ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row mt-7">
                            ...
                            <div class="col-xl-6">
                                <div class="row g-0 align-items-center mb-15px pb-15px border-bottom border-color-extra-medium-gray">
                                    ...
                                    <div class="col"><?php echo $row['shop_code']; ?></div>
                                </div>
                                <div class="row g-0 align-items-center mb-15px pb-15px border-bottom border-color-extra-medium-gray">
                                    <div class="col">
                                        <!-- start features box item -->
                                    ...
                                    <div class="col"><?php echo $row['shop_type']; ?></div>
                                </div>
                                <div class="row g-0 align-items-center mb-15px pb-15px border-bottom border-color-extra-medium-gray">
                                    <div class="col">
                                        <!-- start features box item -->
                                ...
                                <div class="row g-0 align-items-center">
                                    <div class="col">
                                        ...
                                        <div class="feature-box feature-box-left-icon-middle last-paragraph-no-margin">
                                            ...
                                            <div class="feature-box-content">
                                                <span class="text-dark-gray">Total Rooms:</span>
                                            </div>
                                        </div>
                                        <!-- end features box item -->
                                    </div>
                                    <div class="col"><?php echo $row['total_rooms']; ?></div>
                                </div>
                            </div>
                        </div> 
                        <div class="row mt-7">
                         ...
                         <div class="row mt-7">
                           ...
                           <?php
                    $get_features = mysqli_query($conn,"SELECT * FROM tbl_shop_forsale_features WHERE shop_code ='$shop_code' LIMIT 1");
                    ...
                    ?>
                        ...
                        <div class="row mt-7">
                            <div class="col-6">
                                ...
                                <img src="admin/<?php echo $row['front_view']; ?>" class="border-radius-6px" alt="">
                            </div>
                            <div class="col-6">
                                <span class="text-dark-gray fs-24 fw-600 alt-font mb-25px d-block">Inside Views</span>
                                <img src="admin/<?php echo $row['photo1']; ?>" class="border-radius-6px" alt="">
                            </div>
                        </div>
                        <div class="row mt-7">
                            <div class="col-6">
                                <img src="admin/<?php echo $row['photo2']; ?>" class="border-radius-6px" alt="">
                            </div>
                            <div class="col-6">
                                <img src="admin/<?php echo $row['photo3']; ?>" class="border-radius-6px" alt="">
                            </div>
                        </div>
                        <div class="row mt-7">
                            <div class="col-12">
                    ...
                    <div class="col-xl-4 offset-xl-1 col-lg-5">
                        <div class="bg-base-color-light border-radius-6px position-sticky top-120px">
                            <div class="bg-base-color border-radius-6px feature-box overflow-hidden icon-with-text-style-08 ps-35px pe-35px pt-25px pb-20px xs-p-25px">
                                <!-- start features box item -->
                                <div class="feature-box-content">
                                    <span class="text-white alt-font fw-600 fs-20 ">Talk to us today about buying this shop</span>
                                </div>
                                <!-- end features box item -->
                            </div>
                            <div class="ps-45px pe-45px pt-35px pb-45px xs-p-25px contact-form-style-01 mt-0">
                                ...
                                <form action="" method="post">
                                    <div class="position-relative form-group mb-15px">
                                        <input type="text" name="id" value="<?php echo $row['shop_code']; ?>"class="form-control border-color-white box-shadow-large required" placeholder="SHOP ID: <?php echo $row['shop_code']; ?>" disabled="disabled" />
                                    </div>
                                    <div class="position-relative form-group mb-15px">
        ...
        <section class="bg-gradient-very-light-gray">
            <div class="container">
                ...
                <div class="row row-cols-1 row-cols-xl-3 row-cols-lg-2 row-cols-md-2 justify-content-center"> 
                      <!-- start box item -->
                    <?php $res =  mysqli_query($conn,"SELECT * FROM tbl_shop_for_sale  WHERE front_view !=''");
                        $count = mysqli_num_rows($res);
                        if($count > 0) {
                        while($row=mysqli_fetch_assoc($res)){ 
