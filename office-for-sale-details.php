...
<div class="col-auto ms-auto ps-lg-0 d-none d-sm-flex"> 
    ...
    <div class="header-icon">
        ...
        <!-- end header -->
        <?php $res =  mysqli_query($conn,"SELECT * FROM tbl_office_for_sale WHERE office_id = '$office_id'");
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-7 md-mb-50px">
                        ...
                        <div class="row mt-7">
                         ...
                         <div class="row mt-7">
                           ...
                           <?php
                    $get_features = mysqli_query($conn,"SELECT * FROM tbl_office_forsale_features WHERE office_code ='$office_code' LIMIT 1");
                    ...
                    ?>
                        ...
                        <div class="row mt-7">
                            <div class="col-6">
                                <span class="text-dark-gray fs-24 fw-600 alt-font mb-25px d-block">Office Images</span>
                    ...
                    <div class="col-xl-4 offset-xl-1 col-lg-5">
                        <div class="bg-base-color-light border-radius-6px position-sticky top-120px">
                            <div class="bg-base-color border-radius-6px feature-box overflow-hidden icon-with-text-style-08 ps-35px pe-35px pt-25px pb-20px xs-p-25px">
                                <!-- start features box item -->
                                <div class="feature-box-content">
                                    <span class="text-white alt-font fw-600 fs-20 ">Talk to us today about buying this office</span>
                                </div>
                                <!-- end features box item -->
                            </div>
        ...
        <section class="bg-gradient-very-light-gray">
            <div class="container">
                ...
                <div class="row row-cols-1 row-cols-xl-3 row-cols-lg-2 row-cols-md-2 justify-content-center"> 
                     <?php $res =  mysqli_query($conn,"SELECT * FROM tbl_office_for_sale LIMIT 3");
                        $count = mysqli_num_rows($res);
                        if($count > 0) {
                        while($row=mysqli_fetch_assoc($res)){ 
