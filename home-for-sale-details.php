...
if (isset($_POST['submit'])) {
    ...
    $msg = mysqli_query($conn,"INSERT INTO `tbl_orders`(`order_code`, `home_code`, `order_by`, `phone`, `specifications`) VALUES('$order_code','$home_id','$name','$phone','$message') ");
...
<div class="col-auto ms-auto ps-lg-0 d-none d-sm-flex"> 
    ...
    <div class="header-icon">
        ...
        <!-- end header -->
        <?php $res =  mysqli_query($conn,"SELECT * FROM tbl_home_for_sale WHERE home_id = '$home_id'");
        // <?php $res =  mysqli_query($conn,"SELECT tbl_home_rentals.*,tbl_home_features.* FROM tbl_home_rentals INNER JOIN tbl_home_features ON tbl_home_rentals.home_id=tbl_home_features.home_id WHERE tbl_home_rentals.home_id= '$home_id'");
            ...
            <div class="container">
                ...
                <div class="row align-items-center align-items-lg-end justify-content-center extra-very-small-screen g-0">
                    <div class="col-xl-7 col-lg-8 position-relative page-title-extra-small md-mb-30px md-mt-auto" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        <h3 class="alt-font fw-600 text-white mb-15px ls-minus-1px"><?php echo $row['home_name']; ?></h3>
                    ...
                    <div class="col-lg-7 md-mb-50px">
                        ...
                        <div class="row mt-7">
                            ...
                            <div class="col-xl-6">
                                <div class="row g-0 align-items-center mb-15px pb-15px border-bottom border-color-extra-medium-gray">
                                    ...
                                    <div class="col"><?php echo $row['home_code']; ?></div>
                                </div>
                                <div class="row g-0 align-items-center mb-15px pb-15px border-bottom border-color-extra-medium-gray">
                                    <div class="col">
                                        <!-- start features box item -->
                                    ...
                                    <div class="col"><?php echo $row['home_type']; ?></div>
                                </div>
                                <div class="row g-0 align-items-center mb-15px pb-15px border-bottom border-color-extra-medium-gray">
                                    <div class="col">
                                        <!-- start features box item -->
                        ...
                        <div class="row mt-7">
                         ...
                         <div class="row mt-7">
                           ...
                           <?php
                    $get_features = mysqli_query($conn,"SELECT * FROM tbl_home_forsale_features WHERE home_code ='$home_code' LIMIT 1");
                    ...
                    <div class="col-xl-4 offset-xl-1 col-lg-5">
                        <div class="bg-base-color-light border-radius-6px position-sticky top-120px">
                            <div class="bg-base-color border-radius-6px feature-box overflow-hidden icon-with-text-style-08 ps-35px pe-35px pt-25px pb-20px xs-p-25px">
                                <!-- start features box item -->
                                <div class="feature-box-content">
                                    <span class="text-white alt-font fw-600 fs-20 ">Talk to us today about buying this home</span>
                                </div>
                                <!-- end features box item -->
                            </div>
                            <div class="ps-45px pe-45px pt-35px pb-45px xs-p-25px contact-form-style-01 mt-0">
                                ...
                                <span class="alt-font fs-20 fw-600 text-dark-gray d-block mb-25px">Leave your inquiry here</span>
                                <!-- start contact form -->
                                <form action="" method="post">
                                    <div class="position-relative form-group mb-15px">
                                        <input type="text" name="id" value="<?php echo $row['home_code']; ?>"class="form-control border-color-white box-shadow-large required" placeholder="home ID: <?php echo $row['home_code']; ?>" disabled="disabled" />
                                    </div>
                                    <div class="position-relative form-group mb-15px">
        ...
        <section class="bg-gradient-very-light-gray">
            <div class="container">
                ...
                <div class="row row-cols-1 row-cols-xl-3 row-cols-lg-2 row-cols-md-2 justify-content-center"> 
                     <?php $res =  mysqli_query($conn,"SELECT * FROM tbl_home_for_sale LIMIT 3");
                        $count = mysqli_num_rows($res);
                        if($count > 0) {
                        while($row=mysqli_fetch_assoc($res)){ 
                            $home_id =  $row['home_id']; ?>
                            ...
                            <div class="bg-white">
                                ...
                                <div class="row ps-35px pe-35px pt-20px pb-20px md-ps-25px md-pe-25px align-items-center">
                                    ...
                                    <div class="col text-end">
                                        <span class="fs-15 alt-font text-dark-gray fw-700 mb-0"><?php echo $row['price']; ?></span>
                                    </div> 
                                </div> 
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-auto d-flex flex-column flex-md-row align-items-center text-center text-md-start">
                        <div class="text-dark-gray fs-28 alt-font fw-500">1000+ homes ready for <span class="fw-700 text-decoration-line-bottom">renting.</span></div>
