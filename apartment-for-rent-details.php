...
<div class="col-auto ms-auto ps-lg-0 d-none d-sm-flex"> 
    ...
    <div class="header-icon">
        ...
        <!-- end header -->
        <?php $res =  mysqli_query($conn,"SELECT * FROM tbl_apartment_rentals WHERE apartment_id = '$apartment_id'");
            ...
            <div class="container">
                ...
                <div class="row align-items-center align-items-lg-end justify-content-center extra-very-small-screen g-0">
                    ...
                    <div class="col-lg-3 offset-xl-2 offset-lg-1 border-start border-2 border-color-base-color ps-40px sm-ps-25px md-mb-auto">
                        ...
                        <span class="fw-500 fs-18">per <?php echo $row['period']; ?></span>
                    </div>
                </div>
            </b></font>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-7 md-mb-50px">
                        ...
                        <div class="row mt-7">
                           ...
                           <?php
                    $get_features = mysqli_query($conn,"SELECT * FROM tbl_rental_apartment_features WHERE apartment_code ='$apartment_code' LIMIT 1");
...
?>
        ...
        <section class="bg-gradient-very-light-gray">
            <div class="container">
                ...
                <div class="row row-cols-1 row-cols-xl-3 row-cols-lg-2 row-cols-md-2 justify-content-center"> 
                     <?php $res =  mysqli_query($conn,"SELECT * FROM tbl_apartment_rentals LIMIT 3");
                        $count = mysqli_num_rows($res);
                        if($count > 0) {
                        while($row=mysqli_fetch_assoc($res)){ 
  ...
  {
    ?>
          <!-- <center>No  Records Is Found ...</center>-->
        <?php
  }
?>
