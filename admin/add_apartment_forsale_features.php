...
<!-- Content Wrapper. Contains page content -->
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0">APARTMENTS FOR SALE FEATURES SECTION
              <li class="btn btn-sm btn-primary"style="float: right;">
                    <a href="<?php _link(); ?>apartments_for_sale" aria-hidden="false"  title="View Apartments for sale" data-toggle="tooltip" data-placement="right" style="color: white;"><i class="fa fa-fast-backward"></i>&nbsp;Go to Apartments for sale</a>
                    </li> </h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <?php
                    $get_apartment = dbQuery("SELECT * FROM tbl_apartment_for_sale WHERE apartment_code ='$apartment_code' LIMIT 1");
              ...
              <!-- /.card-header -->
              <!-- form start -->
               <form action="features/ASF_update.php" method="post">
<input type="hidden" id="apartment_code" name="apartment_code" value="<?php echo $apartment_code;?>" required>
                <div class="card-body">
                  <div class="row col-md-12 alert alert-success">
                    <?php
                    $get_features = dbQuery("SELECT * FROM tbl_apartment_forsale_features WHERE apartment_code ='$apartment_code' LIMIT 1");
