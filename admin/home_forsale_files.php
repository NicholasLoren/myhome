        ...
        if($file_size < 50000000){
            ...
            if(in_array($end, $allowed_ext)){
                ...
                move_uploaded_file($file_temp, $location1);
                    mysqli_query($conn, "UPDATE tbl_home_for_sale SET tour_video = '$location1' WHERE home_id ='$home_code'") or die(mysqli_error());
...
if(ISSET($_POST['save4'])){
        ...
        if($file_size < 50000000){
            ...
            if(in_array($end, $allowed_ext)){
                $name = date("Ymd").time();
                $location4 = 'images/homes/'.$name.".".$end;
                if(move_uploaded_file($file_temp, $location4)){
                    mysqli_query($conn, "UPDATE tbl_home_for_sale SET front_view = '$location4' WHERE home_id ='$home_code'") or die(mysqli_error());
...
if(ISSET($_POST['save5'])){
        ...
        if($file_size < 50000000){
            ...
            if(in_array($end, $allowed_ext)){
                $name = date("Ymd").time();
                $location5 = 'images/homes/'.$name.".".$end;
                if(move_uploaded_file($file_temp, $location5)){
                    mysqli_query($conn, "UPDATE tbl_home_for_sale SET back_view = '$location5' WHERE home_id ='$home_code'") or die(mysqli_error());
...
if(ISSET($_POST['save6'])){
        ...
        if($file_size < 50000000){
            ...
            if(in_array($end, $allowed_ext)){
                $name = date("Ymd").time();
                $location6 = 'images/homes/'.$name.".".$end;
                if(move_uploaded_file($file_temp, $location6)){
                    mysqli_query($conn, "UPDATE tbl_home_for_sale SET side_view = '$location6' WHERE home_id ='$home_code'") or die(mysqli_error());
...
if(ISSET($_POST['save7'])){
        ...
        if($file_size < 50000000){
            ...
            if(in_array($end, $allowed_ext)){
                $name = date("Ymd").time();
                $location7 = 'images/homes/'.$name.".".$end;
                if(move_uploaded_file($file_temp, $location7)){
                    mysqli_query($conn, "UPDATE tbl_home_for_sale SET aerial_view = '$location7' WHERE home_id ='$home_code'") or die(mysqli_error());
    ...
    <!-- Content Wrapper. Contains page content -->
     <?php
        $chk_files =  dbQuery("SELECT * FROM tbl_home_for_sale WHERE home_id = '$home_code' ");
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-10">
            <h1 class="m-0">Upload Images and Video of <?php echo $rowFiles['home_name']; ?></h1>
          </div><!-- /.col -->
          <div class="col-sm-2">
             <li class="<?php echo ($role==1 or $role==3)?'':' hide';?> btn btn-sm btn-primary" style="float: right; margin-right: 5px;">
            <a href="<?php _link(); ?>homes_for_sale"  aria-hidden="false" title="Back to Rental Homes" data-toggle="tooltip" data-placement="right" style="color: white;"><i class="fa fa-fast-backward"></i> &nbsp;Back </a>&nbsp;&nbsp; 
            </li>   
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
     ...
     <form action="" method="POST" enctype="multipart/form-data">
                <div class="modal-content">
                    <div class="modal-body">
                      <h2>Upload tour video of the Home for sale</h2><hr>  
                        <div class="col-md-6">
     ...
     <!-- Front View -->
        <?php if ($front_view =='') { ?>
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="modal-content">
                    <div class="modal-body">
                        <h2>Upload Front View image of the Home for sale</h2><hr>  
                        <div class="col-md-6">
                            <div class="form-group">
     ...
     <!-- Back View -->
      <?php if ($back_view =='') { ?>
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="modal-content">
                    <div class="modal-body">
                        <h2>Upload Back View image of the Home for sale</h2><hr>  
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Upload Image</label>
     ...
     <!-- Side View -->
      <?php if ($side_view =='') { ?>
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="modal-content">
                    <div class="modal-body">
                        <h2>Upload Side View image of the Home for sale</h2><hr>  
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Upload Image</label>
     ...
     <!-- Aerial View -->
      <?php if ($aerial_view =='') { ?>
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="modal-content">
                    <div class="modal-body">
                        <h2>Upload Aerial View image of the Home for sale</h2><hr>  
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Upload Image</label>
