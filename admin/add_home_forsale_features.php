...
<!-- Content Wrapper. Contains page content -->
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0">HOMES FOR SALE FEATURES SECTION
              <li class="btn btn-sm btn-primary"style="float: right;">
                    <a href="<?php _link(); ?>homes_for_sale" aria-hidden="false"  title="View homes for sale" data-toggle="tooltip" data-placement="right" style="color: white;"><i class="fa fa-fast-backward"></i>&nbsp;Go to homes for sale</a>
                    </li> </h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <?php
                    $get_home = dbQuery("SELECT * FROM tbl_home_for_sale WHERE home_code ='$home_code' LIMIT 1");
              ...
              <!-- /.card-header -->
              <!-- form start -->
               <form action="features/HSF_update.php" method="post">
<input type="hidden" id="home_code" name="home_code" value="<?php echo $home_code;?>" required>
                <div class="card-body">
                  <div class="row col-md-12 alert alert-success">
                    <?php
                    $get_features = dbQuery("SELECT * FROM tbl_home_forsale_features WHERE home_code ='$home_code' LIMIT 1");
