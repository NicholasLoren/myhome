        ...
        if($file_size < 50000000){
            ...
            if(in_array($end, $allowed_ext)){
                ...
                move_uploaded_file($file_temp, $location1);
                    mysqli_query($conn, "UPDATE tbl_shop_for_sale SET tour_video = '$location1' WHERE shop_id ='$shop_code'") or die(mysqli_error());
        ...
        if($file_size < 50000000){
            ...
            if(in_array($end, $allowed_ext)){
                ...
                if(move_uploaded_file($file_temp, $location4)){
                    mysqli_query($conn, "UPDATE tbl_shop_for_sale SET front_view = '$location4' WHERE shop_id ='$shop_code'") or die(mysqli_error());
        ...
        if($file_size < 50000000){
            ...
            if(in_array($end, $allowed_ext)){
                ...
                if(move_uploaded_file($file_temp, $location5)){
                    mysqli_query($conn, "UPDATE tbl_shop_for_sale SET photo1 = '$location5' WHERE shop_id ='$shop_code'") or die(mysqli_error());
        ...
        if($file_size < 50000000){
            ...
            if(in_array($end, $allowed_ext)){
                ...
                if(move_uploaded_file($file_temp, $location6)){
                    mysqli_query($conn, "UPDATE tbl_shop_for_sale SET photo2 = '$location6' WHERE shop_id ='$shop_code'") or die(mysqli_error());
...
if(ISSET($_POST['save7'])){
        ...
        if($file_size < 50000000){
            ...
            if(in_array($end, $allowed_ext)){
                ...
                if(move_uploaded_file($file_temp, $location7)){
                    mysqli_query($conn, "UPDATE tbl_shop_for_sale SET photo3 = '$location7' WHERE shop_id ='$shop_code'") or die(mysqli_error());
    ...
    <!-- Content Wrapper. Contains page content -->
     <?php
        $chk_files =  dbQuery("SELECT * FROM tbl_shop_for_sale WHERE shop_id = '$shop_code' ");
     ...
     <form action="" method="POST" enctype="multipart/form-data">
                <div class="modal-content">
                    <div class="modal-body">
                      <h2>Upload tour video of the Shop for sale</h2><hr>  
                        <div class="col-md-6">
     ...
     <!-- Front View -->
        <?php if ($front_view =='') { ?>
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="modal-content">
                    <div class="modal-body">
                        <h2>Upload Front View image of the Shop for sale</h2><hr>  
                        <div class="col-md-6">
                            <div class="form-group">
     ...
     <!-- Back View -->
      <?php if ($photo1 =='') { ?>
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="modal-content">
                    <div class="modal-body">
                        <h2>Upload First View image of the Shop for sale</h2><hr>  
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Upload Image</label>
     ...
     <!-- Side View -->
      <?php if ($photo2 =='') { ?>
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="modal-content">
                    <div class="modal-body">
                        <h2>Upload Second View image of the Shop for sale</h2><hr>  
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Upload Image</label>
     ...
     <!-- Aerial View -->
      <?php if ($photo3 =='') { ?>
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="modal-content">
                    <div class="modal-body">
                        <h2>Upload Third View image of the Shop for sale</h2><hr>  
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Upload Image</label>
