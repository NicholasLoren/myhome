...
<!-- Content Wrapper. Contains page content -->
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0">SHOPS FOR RENT FEATURES SECTION
              <li class="btn btn-sm btn-primary"style="float: right;">
                    <a href="<?php _link(); ?>listShop_rentals" aria-hidden="false"  title="View shops for rent" data-toggle="tooltip" data-placement="right" style="color: white;"><i class="fa fa-fast-backward"></i>&nbsp;Go to shops for rent</a>
                    </li> </h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <?php
                    $get_shop = dbQuery("SELECT * FROM tbl_shop_rentals WHERE shop_code ='$shop_code' LIMIT 1");
              ...
              <!-- /.card-header -->
              <!-- form start -->
               <form action="features/SRF_update.php" method="post">
<input type="hidden" id="shop_code" name="shop_code" value="<?php echo $shop_code;?>" required>
                <div class="card-body">
                  <div class="row col-md-12 alert alert-success">
                    <?php
                    $get_features = dbQuery("SELECT * FROM tbl_rental_shop_features WHERE shop_code ='$shop_code' LIMIT 1");
