...
<!-- Content Wrapper. Contains page content -->
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">EDIT RENTAL HOMES SECTION</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
 ...
 <p><?php echo $msg; ?></p>
    <!-- Main content -->
     ...
     <!-- body items -->
      <?php $res =  dbQuery("SELECT * FROM tbl_home_rentals WHERE home_id='$home_id'");
               $count = dbNumRows($res);
               if($count > 0) {
