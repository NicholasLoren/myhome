...
if (isset($_POST['submit'])) {
  ...
  $office_rental = dbQuery("UPDATE tbl_office_for_sale SET `office_name`='$office_name', `total_rooms`='$total_rooms', `location`='$location', `longitude`='$longitude', `latitude`='$latitude', `price`='$price', `measurement`='$measurement',  `description`='$description', `office_type`='$office_type', `accomodation_type`='$accomodation_type', `year_built`='$year_built', `waiting_room`='$waiting_room', `cooling`='$cooling', `heating`='$heating', `parking`='$parking', `outdoor`='$outdoor', `listed_by`='$listed_by' WHERE office_id='$office_id'"); 

      if($office_rental){
         $msg = "
     <div class='alert alert-success alert-dismissible'>
        <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
                 Office for sale Successfully Updated
      </div>";
      goToPage("edit_office_for_sale&Id=$office_id");
    }
  } 
?>
<!-- Content Wrapper. Contains page content -->
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">EDIT OFFICES FOR SALE SECTION</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
           <li class="<?php echo ($role==1 or $role==3)?'':' hide';?> btn btn-sm btn-primary" style="float: right; margin-right: 5px;">
            <a href="<?php _link(); ?>offices_for_sale"  aria-hidden="false" title="Back to Offices for sale" data-toggle="tooltip" data-placement="right" style="color: white;"><i class="fa fa-fast-backward"></i> &nbsp;Back </a>&nbsp;&nbsp; 
            </li>   
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
 ...
 <p><?php echo $msg; ?></p>
    <!-- Main content -->
     <?php $res =  dbQuery("SELECT * FROM tbl_office_for_sale WHERE office_id='$office_id'");
               $count = dbNumRows($res);
               if($count > 0) {
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Edit office details of  <?php echo $row['office_name']; ?> [<?php echo $row['office_code']; ?>]</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST">
                <div class="card-body">
                  <div class="row">
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" name="name" class="form-control"  placeholder="Enter Home Name" value="<?php echo $row['office_name']; ?>">
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-2">
                      ...
                      <input type="text" name="total_rooms" class="form-control"  placeholder="Enter Longitude" value="<?php echo $row['total_rooms']; ?>">
                    </div>
                    <div class="form-group col-md-2">
                      <label for="exampleInputtext1">Waiting Rooms</label>
                      <input type="text" name="waiting_room" class="form-control"  placeholder="Enter Longitude" value="<?php echo $row['waiting_room']; ?>">
                    </div>
                    <div class="form-group col-md-2">
                    ...
                    <div class="form-group col-md-2">
                      ...
                      <select name="office_type" class="form-control select2" style="width: 100%;">
                        <option value="<?php echo $row['office_type']; ?>"><?php echo $row['office_type']; ?></option>
