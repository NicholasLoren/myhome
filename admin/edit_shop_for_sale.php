...
<!-- Content Wrapper. Contains page content -->
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">EDIT SHOP FOR SALE DETAILS</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
 ...
 <p><?php echo $msg; ?></p>
    ...
    <section class="content">
     <!-- body items -->
      <?php $res =  dbQuery("SELECT * FROM tbl_shop_for_sale WHERE shop_id='$shop_id'");
               $count = dbNumRows($res);
               if($count > 0) {
