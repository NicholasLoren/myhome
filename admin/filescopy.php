        ...
        if($file_size < 50000000){
            ...
            if(in_array($end, $allowed_ext)){
                ...
                move_uploaded_file($file_temp, $location1);
                    mysqli_query($conn, "UPDATE tbl_apartment_rentals SET tour_video = '$location1' WHERE apartment_id ='15'") or die(mysqli_error());
        ...
        if($file_size < 50000000){
            ...
            if(in_array($end, $allowed_ext)){
                ...
                if(move_uploaded_file($file_temp, $location2)){
                    mysqli_query($conn, "UPDATE tbl_apartment_rentals SET ground_floor = '$location2' WHERE apartment_id ='15'") or die(mysqli_error());
        ...
        if($file_size < 50000000){
            ...
            if(in_array($end, $allowed_ext)){
                ...
                if(move_uploaded_file($file_temp, $location3)){
                    mysqli_query($conn, "UPDATE tbl_apartment_rentals SET first_floor = '$location3' WHERE apartment_id ='15'") or die(mysqli_error());
        ...
        if($file_size < 50000000){
            ...
            if(in_array($end, $allowed_ext)){
                ...
                if(move_uploaded_file($file_temp, $location4)){
                    mysqli_query($conn, "UPDATE tbl_apartment_rentals SET front_view = '$location4' WHERE apartment_id ='15'") or die(mysqli_error());
        ...
        if($file_size < 50000000){
            ...
            if(in_array($end, $allowed_ext)){
                ...
                if(move_uploaded_file($file_temp, $location5)){
                    mysqli_query($conn, "UPDATE tbl_apartment_rentals SET back_view = '$location5' WHERE apartment_id ='15'") or die(mysqli_error());
        ...
        if($file_size < 50000000){
            ...
            if(in_array($end, $allowed_ext)){
                ...
                if(move_uploaded_file($file_temp, $location6)){
                    mysqli_query($conn, "UPDATE tbl_apartment_rentals SET side_view = '$location6' WHERE apartment_id ='15'") or die(mysqli_error());
        ...
        if($file_size < 50000000){
            ...
            if(in_array($end, $allowed_ext)){
                ...
                if(move_uploaded_file($file_temp, $location7)){
                    mysqli_query($conn, "UPDATE tbl_apartment_rentals SET aerial_view = '$location7' WHERE apartment_id ='15'") or die(mysqli_error());
