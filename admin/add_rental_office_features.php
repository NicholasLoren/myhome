...
<!-- Content Wrapper. Contains page content -->
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0">OFFICES FOR RENT FEATURES SECTION
              <li class="btn btn-sm btn-primary"style="float: right;">
                    <a href="<?php _link(); ?>listOffice_rentals" aria-hidden="false"  title="View offices for rent" data-toggle="tooltip" data-placement="right" style="color: white;"><i class="fa fa-fast-backward"></i>&nbsp;Go to offices for rent</a>
                    </li> </h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <?php
                    $get_office = dbQuery("SELECT * FROM tbl_office_rentals WHERE office_code ='$office_code' LIMIT 1");
              ...
              <!-- /.card-header -->
              <!-- form start -->
               <form action="features/ROF_update.php" method="post">
<input type="hidden" id="office_code" name="office_code" value="<?php echo $office_code;?>" required>
                <div class="card-body">
                  <div class="row col-md-12 alert alert-success">
                    <?php
                    $get_features = dbQuery("SELECT * FROM tbl_rental_office_features WHERE office_code ='$office_code' LIMIT 1");
