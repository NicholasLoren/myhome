        ...
        if($file_size < 50000000){
            ...
            if(in_array($end, $allowed_ext)){
                ...
                move_uploaded_file($file_temp, $location1);
                    mysqli_query($conn, "UPDATE tbl_apartment_for_sale SET tour_video = '$location1' WHERE apartment_id ='$apartment_code'") or die(mysqli_error());
        ...
        if($file_size < 50000000){
            ...
            if(in_array($end, $allowed_ext)){
                ...
                if(move_uploaded_file($file_temp, $location2)){
                    mysqli_query($conn, "UPDATE tbl_apartment_for_sale SET ground_floor = '$location2' WHERE apartment_id ='$apartment_code'") or die(mysqli_error());
        ...
        if($file_size < 50000000){
            ...
            if(in_array($end, $allowed_ext)){
                ...
                if(move_uploaded_file($file_temp, $location3)){
                    mysqli_query($conn, "UPDATE tbl_apartment_for_sale SET first_floor = '$location3' WHERE apartment_id ='$apartment_code'") or die(mysqli_error());
        ...
        if($file_size < 50000000){
            ...
            if(in_array($end, $allowed_ext)){
                ...
                if(move_uploaded_file($file_temp, $location4)){
                    mysqli_query($conn, "UPDATE tbl_apartment_for_sale SET front_view = '$location4' WHERE apartment_id ='$apartment_code'") or die(mysqli_error());
        ...
        if($file_size < 50000000){
            ...
            if(in_array($end, $allowed_ext)){
                ...
                if(move_uploaded_file($file_temp, $location5)){
                    mysqli_query($conn, "UPDATE tbl_apartment_for_sale SET back_view = '$location5' WHERE apartment_id ='$apartment_code'") or die(mysqli_error());
        ...
        if($file_size < 50000000){
            ...
            if(in_array($end, $allowed_ext)){
                ...
                if(move_uploaded_file($file_temp, $location6)){
                    mysqli_query($conn, "UPDATE tbl_apartment_for_sale SET side_view = '$location6' WHERE apartment_id ='$apartment_code'") or die(mysqli_error());
...
if(ISSET($_POST['save7'])){
        ...
        if($file_size < 50000000){
            ...
            if(in_array($end, $allowed_ext)){
                ...
                if(move_uploaded_file($file_temp, $location7)){
                    mysqli_query($conn, "UPDATE tbl_apartment_for_sale SET aerial_view = '$location7' WHERE apartment_id ='$apartment_code'") or die(mysqli_error());
    ...
    <!-- Content Wrapper. Contains page content -->
     <?php
        $chk_files =  dbQuery("SELECT * FROM tbl_apartment_for_sale WHERE apartment_id = '$apartment_code' ");
