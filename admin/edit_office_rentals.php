...
<!-- Content Wrapper. Contains page content -->
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">EDIT RENTAL OFFICES SECTION</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
 ...
 <p><?php echo $msg; ?></p>
    <!-- Main content -->
     <?php $res =  dbQuery("SELECT * FROM tbl_office_rentals WHERE office_id='$office_id'");
               $count = dbNumRows($res);
               if($count > 0) {
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Edit Rental office details of  <?php echo $row['office_name']; ?> [<?php echo $row['office_code']; ?>]</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST">
