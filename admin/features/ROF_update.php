...
$sql = "UPDATE tbl_rental_office_features SET " . implode(', ', $updateFields) . " WHERE office_code = '" . $conn->real_escape_string($office_code) . "'";

if ($conn->query($sql) === TRUE) {
    $msg = "Record updated successfully";
    header("location: ../index.php?page=add_rental_office_features&Id=$office_code");
} else {
