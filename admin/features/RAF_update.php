...
$sql = "UPDATE tbl_rental_apartment_features SET " . implode(', ', $updateFields) . " WHERE apartment_code = '" . $conn->real_escape_string($apartment_code) . "'";

if ($conn->query($sql) === TRUE) {
    $msg = "Record updated successfully";
    header("location: ../index.php?page=add_rental_apartment_features&Id=$apartment_code");
} else {
