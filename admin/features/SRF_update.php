...
$sql = "UPDATE tbl_rental_shop_features SET " . implode(', ', $updateFields) . " WHERE shop_code = '" . $conn->real_escape_string($shop_code) . "'";

if ($conn->query($sql) === TRUE) {
    $msg = "Record updated successfully";
    header("location: ../index.php?page=add_rental_shop_features&Id=$shop_code");
} else {
