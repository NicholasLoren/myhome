...
$sql = "UPDATE tbl_home_forsale_features SET " . implode(', ', $updateFields) . " WHERE home_code = '" . $conn->real_escape_string($home_code) . "'";

if ($conn->query($sql) === TRUE) {
    $msg = "Record updated successfully";
    header("location: ../index.php?page=add_home_forsale_features&Id=$home_code");
} else {
