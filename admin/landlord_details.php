...
<!-- Content Wrapper. Contains page content -->
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">LANDLORD'S DETAILS</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
           ...
           <li class="<?php echo ($role==1 or $role==3)?'':' hide';?> btn btn-sm btn-primary" style="float: right; margin-right: 5px;">
            <a href="<?php _link(); ?>landlord_house_status"  aria-hidden="false" title="Back to Properrty Status" data-toggle="tooltip" data-placement="right" style="color: white;"><i class="fa fa-fast-backward"></i> &nbsp;Back to Properrty Status </a>&nbsp;&nbsp; 
            </li>   
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <!-- /.content-header -->
    <!-- Main content -->
     <?php $res =  dbQuery("SELECT * FROM tbl_landlords WHERE landlord_id='$Id'");
               $count = dbNumRows($res);
               if($count > 0) {
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
                <div class="card-body">
                  <div class="row">
                    <div class=" col-md-6">
                      <label>Fullnames : <?php echo $row['fullnames']; ?></label>
                    </div>
                    <div class="col-md-6">
                      <label for="exampleInputtext1">Phone : <?php echo $row['phone']; ?></label>
                    </div> 
                    <div class="col-md-6">
                      <label for="exampleInputtext1">Location : <?php echo $row['location']; ?></label>
                    </div>
                    <div class=" col-md-6">
                      <label>Status : 
                       <?php
