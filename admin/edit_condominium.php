...
if (isset($_POST['submit'])) {
  ...
  $condominium = dbQuery("UPDATE tbl_condominiums SET `condo_name`='$condo_name', `location`='$location', `longitude`='$longitude', `latitude`='$latitude', `price`='$price', `measurement`='$measurement',  `description`='$description', `condo_type`= '$condo_type', `year_built`='$year_built', `accomodation_type`='$accomodation_type', `bedrooms`='$bedrooms', `bathrooms`='$bathrooms', `dining_room`='$dining_room', `sitting_room`='$sitting_room', `visitors_room`='$visitors_room', `office_room`= '$office_room', `kitchen`= '$kitchen', `cooling`='$cooling', `heating`='$heating', `parking`='$parking', `outdoor`='$outdoor', `swimming_pool`='$swimming_pool', `total_floors`='$total_floors', `living_area`='$living_area', `status`='$status' WHERE condo_id = '$condo_id'"); 

      if($condominium){
        $msg = "
     <div class='alert alert-success alert-dismissible'>
        <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
               Condominium for sale Successfully Updated
      </div>";
      goToPage("edit_condominium&Id=$condo_id");
    }
  } 
?>
<!-- Content Wrapper. Contains page content -->
    ...
    <div class="content-header">
      <div class="container-fluid">
        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">EDIT CONDOMINIUM DETAILS</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
           <li class="<?php echo ($role==1 or $role==3)?'':' hide';?> btn btn-sm btn-primary" style="float: right; margin-right: 5px;">
            <a href="<?php _link(); ?>condominiums_for_sale"  aria-hidden="false" title="Back to Condominiums for sale" data-toggle="tooltip" data-placement="right" style="color: white;"><i class="fa fa-fast-backward"></i> &nbsp;Back </a>&nbsp;&nbsp; 
            </li>   
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
     <!-- body items -->
      <?php $res =  dbQuery("SELECT * FROM tbl_condominiums WHERE condo_id='$condo_id'");
               $count = dbNumRows($res);
               if($count > 0) {
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Edit details of <?php echo $row['condo_name']; ?> [<?php echo $row['condo_code']; ?>]</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST">
                <div class="card-body">
                  <div class="row">
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" name="name" class="form-control"  placeholder="Enter Condo Name" value="<?php echo $row['condo_name']; ?>">
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-2">
                      ...
                      <select name="condo_type" class="form-control select2" style="width: 100%;">
                        <option value="<?php echo $row['condo_type']; ?>"><?php echo $row['condo_type']; ?></option>
                        <option value="Family Condo">Family Condo</option>
