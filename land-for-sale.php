...
<div class="col-auto ms-auto ps-lg-0 d-none d-sm-flex"> 
    ...
    <div class="header-icon">
        ...
        <!-- end header -->
        <!-- start page title -->
        <section class="cover-background page-title-big-typography ipad-top-space-margin" style="background-image: url(images/land3.jpg); background-repeat: no-repeat;">
            <div class="container">
                <div class="row align-items-center align-items-lg-end justify-content-center extra-very-small-screen g-0">
                    <div class="col-xxl-5 col-xl-6 col-lg-7 position-relative page-title-extra-small md-mb-30px md-mt-auto" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        <h2 class="alt-font text-white fw-500 mb-0 ls-minus-1px shadow-none" data-shadow-animation="true" data-animation-delay="700">Buy land from us in your desired location</span></h2><br>
                        <h1 class="text-white">We help you find land in all parts of the country.</h1>
                        
                    </div>
                    <div class="col-lg-5 offset-xxl-2 offset-xl-1 border-start border-2 border-color-base-color ps-40px sm-ps-25px md-mb-auto fs-22">
                        <font color="white"><b> <span class="d-block w-85 lg-w-100" data-anime='{ "el": "lines", "translateY": [15, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>We have got both residential and commercial land at affordable prices and with access to main roads. When you buy land from us, you receive your land title deeds within 24 hours of full payment. Land prices start at 2M per plot depending on the type of land you’re after..</span></b></font>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container"> 
                <div class="row mb-4 xs-mb-10 pt-9" id="rentals">
                    <div class="col-12 text-center">
                        <h3 class="alt-font text-dark-gray fw-500 ls-minus-1px shadow-none" data-shadow-animation="true" data-animation-delay="700" data-anime='{ "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>Latest Land for <span class="fw-700 text-highlight">sale<span class="bg-base-color h-10px bottom-10px opacity-3 separator-animation"></span></span></h3>
                    </div>
                </div>
                <div class="row row-cols-1 row-cols-xl-3 row-cols-md-2 justify-content-center" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'> 
                    <!-- start box item -->
                    <?php $res =  mysqli_query($conn,"SELECT * FROM tbl_land_for_sale WHERE photo1 !=''");
                    ...
                    <div class="col mb-30px">
                        <div class="border-radius-6px overflow-hidden box-shadow-large">
                            <div class="image position-relative">
                                <a href="land-for-sale-details.php?id=<?php echo $row['land_id']; ?>">
                                    <img src="admin/<?php echo $row['photo1']; ?>" alt="" style="max-height: 260px;">
                                </a>
                            ...
                            <div class="bg-white">
                                <div class="content ps-40px pe-40px pt-35px pb-35px md-p-25px border-bottom border-color-transparent-dark-very-light">
                                    <div class="d-flex align-items-center">
                                        <a href="land-for-sale-details.php?id=<?php echo $row['land_id']; ?>" class="alt-font text-dark-gray fw-700 fs-22 me-10px"><?php echo $row['plot_name']; ?></a>
                                    </div>
                                    <p class="mb-20px"><?php echo $row['location']; ?></p>
                                    <div class="row g-0">
                                        <div class="col">
                                            <span class="d-block lh-18 fs-15">Size : <?php echo $row['measurements']; ?></span> 
                                        </div>
                                        <div class="col">
                                            <span class="d-block lh-18 fs-15">Type : <?php echo $row['land_type']; ?></span> 
                                        </div>
                                    </div>
                                </div> 
                                <div class="row ps-35px pe-35px pt-20px pb-20px md-ps-25px md-pe-25px align-items-center">
                                    <div class="col">
                                        <a href="land-for-sale-details.php?id=<?php echo $row['land_id']; ?>" class="btn btn-dark-gray btn-very-small btn-round-edge fw-600">View details</a>
                                    </div>
             ...
             <div class="container">
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-auto d-flex flex-column flex-md-row align-items-center text-center text-md-start">
                        <div class="text-dark-gray fs-28 alt-font fw-500">1000+ lands ready for <span class="fw-700 text-decoration-line-bottom">rent.</span></div>
