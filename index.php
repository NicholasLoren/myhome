        ...
        <section class="p-0 top-space-margin">
            <div class="swiper full-screen md-h-600px sm-h-500px swiper-number-pagination-style-01" data-slider-options='{ "slidesPerView": 1, "loop": true, "pagination": { "el": ".swiper-number", "clickable": true }, "navigation": { "nextEl": ".slider-one-slide-next-1", "prevEl": ".slider-one-slide-prev-1" }, "autoplay": { "delay": 4000, "disableOnInteraction": false },  "keyboard": { "enabled": true, "onlyInViewport": true }, "effect": "slide" }' data-number-pagination="1">
                <div class="swiper-wrapper">
                        ...
                        <div class="container h-100">
                            <div class="row align-items-center h-100">
                                <div class="col-md-8 position-relative text-white" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                                    ...
                                    <a href="apartment-for-sale-details.php?id=<?php echo $AS_apartment_id; ?>" class="btn btn-transparent-white-light border-1 btn-large btn-round-edge fw-500 xs-mt-10px xs-mb-10px">View details</a>
                                </div>
                            </div> 
                        </div>
                        <div class="position-absolute col-xxl-5 col-lg-6 right-0px bottom-0px pt-50px pb-40px ps-40px pe-40px lg-p-35px d-none d-lg-inline-block bg-white border-radius-left-8px" data-anime='{ "translateX": [50, 0], "translateY": [0, 0], "opacity": [0,1], "duration": 600, "delay": 300, "staggervalue": 300, "easing": "easeOutQuad" }'>
                            <div class="row justify-content-center">
                                ...
                                <div class="col-xl-5 ps-35px lg-ps-15px text-center text-xl-start">
                                    ...
                                    <h4 class="text-dark-gray fs-20 fw-700 alt-font mb-0 ls-minus-1px"><?php echo $AS_price; ?></h4>
                                </div>
                            </div>
                        </div> 
                    </div>
                    <!-- end slider item -->
                    <!-- start slider item -->
                    <div class="swiper-slide cover-background" style="background-image:url('admin/<?php echo $CS_front_view; ?>');"> 
                        <div class="container h-100">
                            <div class="row align-items-center h-100">
                                <div class="col-md-8 position-relative text-white" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                                    <span class="fs-20 d-block mb-15px"><?php echo $CS_location; ?></span>
                                    <div class="alt-font fs-110 lg-fs-90 lh-90 lg-lh-80 mb-45px sm-mb-25px w-80 xs-w-100 ls-minus-2px"><?php echo $CS_condo_name; ?></div>  
                                    <a href="real-estate-contact.php" class="btn btn-white btn-large border-1 btn-round-edge btn-box-shadow me-15px xs-mt-10px xs-mb-10px">Schedule visit</a>
                                    <a href="condominium-for-sale-details.php?id=<?php echo $CS_condo_id; ?>" class="btn btn-transparent-white-light border-1 btn-large btn-round-edge fw-500 xs-mt-10px xs-mb-10px">View details</a>
                                </div>
                            </div> 
                        </div>
                        <div class="position-absolute col-xxl-5 col-lg-6 right-0px bottom-0px pt-50px pb-40px ps-40px pe-40px lg-p-35px d-none d-lg-inline-block bg-white border-radius-left-8px" data-anime='{ "translateX": [50, 0], "translateY": [0, 0], "opacity": [0,1], "duration": 600, "delay": 300, "staggervalue": 300, "easing": "easeOutQuad" }'>
                            <div class="row justify-content-center">
                                <div class="col-xl-7 lg-mb-25px">
                                    <div class="row">
                                        <div class="col text-center border-end border-color-extra-medium-gray">
                                            <img class="mb-5px h-50px" src="images/demo-real-estate-icon-bed.svg" alt="">
                                            <span class="alt-font fs-16 fw-500 d-block"><?php echo $CS_bedrooms; ?> Bedrooms</span>
                                        </div>
                                        <div class="col text-center border-end border-color-extra-medium-gray">
                                            <img class="mb-5px h-50px" src="images/demo-real-estate-icon-bath.svg" alt="">
                                            <span class="alt-font fs-16 fw-500 d-block"><?php echo $CS_bathrooms; ?>Bathrooms</span>
                                        </div>
                                        <div class="col text-center border-end lg-border-end-0 border-color-extra-medium-gray">
                                            <img class="mb-5px h-50px" src="images/demo-real-estate-icon-car.svg" alt="">
                                            <span class="alt-font fs-12 fw-500 d-block"><?php echo $CS_parking; ?></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-5 ps-35px lg-ps-15px text-center text-xl-start">
                                    <span class="fw-500 mb-5px d-block alt-font">For sell price</span>
                                    <h4 class="text-dark-gray fs-20 fw-700 alt-font mb-0 ls-minus-1px"><?php echo $CS_price; ?></h4>
                                </div>
                            </div>
                        </div> 
                    </div>
                    <!-- end slider item -->
                    <!-- start slider item -->
                    <div class="swiper-slide cover-background" style="background-image:url('admin/<?php echo $HS_front_view; ?>');"> 
                        <div class="container h-100">
                            <div class="row align-items-center h-100">
                                <div class="col-md-8 position-relative text-white" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                                    <span class="fs-20 d-block mb-15px"><?php echo $HS_location; ?></span>
                                    <div class="alt-font fs-110 lg-fs-90 lh-90 lg-lh-80 mb-45px sm-mb-25px w-80 xs-w-100 ls-minus-2px"><?php echo $HS_home_name; ?></div>  
                                    <a href="real-estate-contact.php" class="btn btn-white btn-large border-1 btn-round-edge btn-box-shadow me-15px xs-mt-10px xs-mb-10px">Schedule visit</a>
                                    <a href="home-for-sale-details.php?id=<?php echo $HS_home_id; ?>" class="btn btn-transparent-white-light border-1 btn-large btn-round-edge fw-500 xs-mt-10px xs-mb-10px">View details</a>
                                </div>
                            </div> 
                        </div>
                        <div class="position-absolute col-xxl-5 col-lg-6 right-0px bottom-0px pt-50px pb-40px ps-40px pe-40px lg-p-35px d-none d-lg-inline-block bg-white border-radius-left-8px" data-anime='{ "translateX": [50, 0], "translateY": [0, 0], "opacity": [0,1], "duration": 600, "delay": 300, "staggervalue": 300, "easing": "easeOutQuad" }'>
                            <div class="row">
                                <div class="col-xl-7 lg-mb-25px">
                                    <div class="row">
                                        <div class="col text-center border-end border-color-extra-medium-gray">
                                            <img class="mb-5px h-50px" src="images/demo-real-estate-icon-bed.svg" alt="">
                                            <span class="alt-font fs-16 fw-500 d-block"><?php echo $HS_bedrooms; ?> Bedrooms</span>
                                        </div>
                                        <div class="col text-center border-end border-color-extra-medium-gray">
                                            <img class="mb-5px h-50px" src="images/demo-real-estate-icon-bath.svg" alt="">
                                            <span class="alt-font fs-16 fw-500 d-block"><?php echo $HS_bathrooms; ?>Bathrooms</span>
                                        </div>
                                        <div class="col text-center border-end lg-border-end-0 border-color-extra-medium-gray">
                                            <img class="mb-5px h-50px" src="images/demo-real-estate-icon-car.svg" alt="">
                                            <span class="alt-font fs-12 fw-500 d-block"><?php echo $HS_parking; ?></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-5 ps-35px lg-ps-15px text-center text-xl-start">
                                    <span class="fw-500 mb-5px d-block alt-font">For sell price</span>
                                    <h4 class="text-dark-gray fs-20 fw-700 alt-font mb-0 ls-minus-1px"><?php echo $HS_price; ?></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    <!-- end slider item -->
                    <!-- start slider item -->
                    <div class="swiper-slide cover-background" style="background-image:url('admin/<?php echo $OS_front_view; ?>');"> 
                        <div class="container h-100">
                            <div class="row align-items-center h-100">
                                <div class="col-md-8 position-relative text-white" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                                    <span class="fs-20 d-block mb-15px"><?php echo $OS_location; ?></span>
                                    <div class="alt-font fs-110 lg-fs-90 lh-90 lg-lh-80 mb-45px sm-mb-25px w-70 xs-w-100 ls-minus-2px"><?php echo $OS_office_name; ?></div>  
                                    <a href="real-estate-contact.php" class="btn btn-white btn-large border-1 btn-round-edge btn-box-shadow me-15px xs-mt-10px xs-mb-10px">Schedule visit</a>
                                    <a href="office-for-sale-details?id=<?php echo $OS_office_id; ?>" class="btn btn-transparent-white-light border-1 btn-large btn-round-edge fw-500 xs-mt-10px xs-mb-10px">View details</a>
                                </div>
                            </div> 
                        </div>
                        <div class="position-absolute col-xxl-5 col-lg-6 right-0px bottom-0px pt-50px pb-40px ps-40px pe-40px lg-p-35px d-none d-lg-inline-block bg-white border-radius-left-8px" data-anime='{ "translateX": [50, 0], "translateY": [0, 0], "opacity": [0,1], "duration": 600, "delay": 300, "staggervalue": 300, "easing": "easeOutQuad" }'>
                            <div class="row">
                                <div class="col-md-8 lg-mb-25px">
                                    <div class="row">
                                        <div class="col-md-3 text-center border-end border-color-extra-medium-gray">
                                            <span class="alt-font fs-16 fw-500 d-block">Rooms<br><?php echo $OS_total_rooms; ?></span>
                                        </div>
                                        <div class="col-md-4 text-center border-end border-color-extra-medium-gray">
                                            <span class="alt-font fs-15 fw-500 d-block"> Waiting Rooms<br><?php echo $OS_waiting_room; ?></span>
                                        </div>
                                        <div class="col-md-5 text-center border-end lg-border-end-0 border-color-extra-medium-gray">
                                            <span class="alt-font fs-16 fw-500 d-block">Outdoor :<br><?php echo $OS_outdoor; ?></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4 ps-35px lg-ps-15px text-center text-xl-start">
                                    <span class="fw-600 mb-5px d-block alt-font">For sell price</span>
                                    <h4 class="text-dark-gray fs-18 fw-700 alt-font mb-0 ls-minus-1px"><?php echo $OS_price; ?></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- start slider item for shops -->
                    <div class="swiper-slide cover-background" style="background-image:url('admin/<?php echo $SS_front_view; ?>');"> 
                        <div class="container h-100">
                            <div class="row align-items-center h-100">
                                <div class="col-md-8 position-relative text-white" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                                    <span class="fs-20 d-block mb-15px"><?php echo $SS_location; ?></span>
                                    <div class="alt-font fs-110 lg-fs-90 lh-90 lg-lh-80 mb-45px sm-mb-25px w-70 xs-w-100 ls-minus-2px"><?php echo $SS_shop_name; ?></div>  
                                    <a href="real-estate-contact.php" class="btn btn-white btn-large border-1 btn-round-edge btn-box-shadow me-15px xs-mt-10px xs-mb-10px">Schedule visit</a>
                                    <a href="shop-for-sale-details.php?id=<?php echo $SS_shop_id; ?>" class="btn btn-transparent-white-light border-1 btn-large btn-round-edge fw-500 xs-mt-10px xs-mb-10px">View details</a>
                                </div>
                            </div> 
                        </div>
                        <div class="position-absolute col-xxl-5 col-lg-6 right-0px bottom-0px pt-50px pb-40px ps-40px pe-40px lg-p-35px d-none d-lg-inline-block bg-white border-radius-left-8px" data-anime='{ "translateX": [50, 0], "translateY": [0, 0], "opacity": [0,1], "duration": 600, "delay": 300, "staggervalue": 300, "easing": "easeOutQuad" }'>
                            <div class="row">
                                <div class="col-md-8 lg-mb-25px">
                                    <div class="row">
                                        <div class="col-md-3 text-center border-end border-color-extra-medium-gray">
                                            <span class="alt-font fs-16 fw-500 d-block">Rooms<br><?php echo $SS_total_rooms; ?></span>
                                        </div>
                                        <div class="col-md-4 text-center border-end border-color-extra-medium-gray">
                                            <span class="alt-font fs-15 fw-500 d-block"> Store Rooms<br><?php echo $SS_store_room; ?></span>
                                        </div>
                                        <div class="col-md-5 text-center border-end lg-border-end-0 border-color-extra-medium-gray">
                                            <span class="alt-font fs-16 fw-500 d-block">Outdoor :<br><?php echo $SS_outdoor; ?></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4 ps-35px lg-ps-15px text-center text-xl-start">
                                    <span class="fw-600 mb-5px d-block alt-font">For sell price</span>
                                    <h4 class="text-dark-gray fs-18 fw-700 alt-font mb-0 ls-minus-1px"><?php echo $SS_price; ?></h4>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="bg-very-light-gray">
            <div class="container">
                ...
                <div class="row row-cols-1 row-cols-xl-3 row-cols-md-2 justify-content-center" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'> 
                    ...
                    <!-- start apartment for sale box item -->
                    <div class="col mb-30px">
                        <div class="border-radius-6px overflow-hidden box-shadow-large">
                            <div class="image position-relative">
                                <a href="apartment-for-sale-details.php?id=<?php echo $AS_apartment_id; ?>">
                                    <img src="admin/<?php echo $AS_front_view; ?>" alt="" style="max-height: 260px;">
                                </a>
                            ...
                            <div class="bg-white">
                                <div class="content ps-40px pe-40px pt-35px pb-35px md-p-25px border-bottom border-color-transparent-dark-very-light">
                                    <div class="d-flex align-items-center">
                                        <a href="apartment-for-sale-details.php?id=<?php echo $AS_apartment_id; ?>" class="alt-font text-dark-gray fw-700 fs-22 me-10px"><?php echo $AS_apartment_name; ?></a>
                                    </div>
                                    <p class="mb-20px"><?php echo $AS_location; ?></p>
                                    <div class="row g-0">
                                        <div class="col">
                                            <div class="d-flex align-items-center">
                                                <img src="images/demo-real-estate-icon-bed-small.svg" class="me-5px h-20px" alt="">
                                                <span class="fw-600 alt-font text-dark-gray"><?php echo $AS_bedrooms; ?></span>
                                            </div>
                                            <span class="d-block lh-18 fs-15">Bedrooms</span> 
                                        </div>
                                        <div class="col">
                                            <div class="d-flex align-items-center">
                                                <img src="images/demo-real-estate-icon-bath-small.svg" class="me-5px h-20px" alt="">
                                                <span class="fw-600 alt-font text-dark-gray"><?php echo $AS_bathrooms; ?></span>
                                            </div>
                                            <span class="d-block lh-18 fs-15">Bathrooms</span> 
                                        </div>
                                        <div class="col">
                                            <div class="d-flex align-items-center">
                                                <img src="images/demo-real-estate-icon-size-small.svg" class="me-5px h-20px" alt="">
                                                <span class="fw-600 alt-font text-dark-gray"><?php echo $AS_living_area; ?><sup>2</sup></span>
                                            </div>
                                            <span class="d-block lh-18 fs-15">Living area</span> 
                                        </div>
                                    </div>
                                ...
                                <div class="row ps-35px pe-35px pt-20px pb-20px md-ps-25px md-pe-25px align-items-center">
                                    <div class="col">
                                        <a href="apartment-for-sale-details.php?id=<?php echo $AS_apartment_id; ?>" class="btn btn-dark-gray btn-very-small btn-round-edge fw-600">View details</a>
                                    </div>
                                    <div class="col text-end">
                                        <span class="fs-15 alt-font text-dark-gray fw-700 mb-0">Price : <?php echo $AS_price; ?></span>
                                    </div> 
                                </div> 
                            </div>
                        </div>
                    ...
                    <!-- start home for sale box item -->
                    <div class="col mb-30px">
                        <div class="border-radius-6px overflow-hidden box-shadow-large">
                            <div class="image position-relative">
                                <a href="home-for-sale-details.php?id=<?php echo $HS_home_id; ?>">
                                    <img src="admin/<?php echo $HS_front_view; ?>" alt="">
                                </a>
                            ...
                            <div class="bg-white">
                                <div class="content ps-40px pe-40px pt-35px pb-35px md-p-25px border-bottom border-color-transparent-dark-very-light">
                                    <div class="d-flex align-items-center">
                                        <a href="home-for-sale-details.php?id=<?php echo $row['home_id']; ?>" class="alt-font text-dark-gray fw-700 fs-22 me-10px"><?php echo $HS_home_name; ?></a>
                                    </div>
                                    <p class="mb-20px"><?php echo $HS_location; ?></p>
                                    <div class="row g-0">
                                        <div class="col">
                                            <div class="d-flex align-items-center">
                                                <img src="images/demo-real-estate-icon-bed-small.svg" class="me-5px h-20px" alt="">
                                                <span class="fw-600 alt-font text-dark-gray"><?php echo $HS_bedrooms; ?></span>
                                            </div>
                                            <span class="d-block lh-18 fs-15">Bedrooms</span> 
                                        </div>
                                        <div class="col">
                                            <div class="d-flex align-items-center">
                                                <img src="images/demo-real-estate-icon-bath-small.svg" class="me-5px h-20px" alt="">
                                                <span class="fw-600 alt-font text-dark-gray"><?php echo $HS_bathrooms; ?></span>
                                            </div>
                                            <span class="d-block lh-18 fs-15">Bathrooms</span> 
                                        </div>
                                        <div class="col">
                                            <div class="d-flex align-items-center">
                                                <img src="images/demo-real-estate-icon-size-small.svg" class="me-5px h-20px" alt="">
                                                <span class="fw-600 alt-font text-dark-gray"><?php echo $HS_living_area; ?><sup>2</sup></span>
                                            </div>
                                            <span class="d-block lh-18 fs-15">Living area</span> 
                                        </div>
                                    </div>
                                ...
                                <div class="row ps-35px pe-35px pt-20px pb-20px md-ps-25px md-pe-25px align-items-center">
                                    <div class="col">
                                        <a href="home-for-sale-details.php?id=<?php echo $HS_home_id; ?>" class="btn btn-dark-gray btn-very-small btn-round-edge fw-600">View details</a>
                                    </div>
                                    <div class="col text-end">
                                        <span class="fs-15 alt-font text-dark-gray fw-700 mb-0">Price : <br><?php echo $HS_price; ?></span>
                                    </div> 
                                </div> 
                            </div>
                        </div>
                    ...
                    <!-- start office for sale box item -->
                    <div class="col mb-30px">
                        <div class="border-radius-6px overflow-hidden box-shadow-large">
                            <div class="image position-relative">
                                <a href="office-for-sale-details.php?id=<?php echo $OS_office_id; ?>">
                                    <img src="admin/<?php echo $OS_front_view; ?>" alt="">
                                </a>
                            ...
                            <div class="bg-white">
                                <div class="content ps-40px pe-40px pt-35px pb-35px md-p-25px border-bottom border-color-transparent-dark-very-light">
                                    <div class="d-flex align-items-center">
                                        <a href="office-for-sale-details.php?id=<?php echo $OS_office_id; ?>" class="alt-font text-dark-gray fw-700 fs-22 me-10px"><?php echo $OS_office_name; ?></a>
                                    </div>
                                    <p class="mb-20px"><?php echo $OS_location; ?></p>
                                    <div class="row g-0">
                                        <div class="col">
                                            <div class="d-flex align-items-center">
                                                <img src="images/demo-real-estate-icon-bed-small.svg" class="me-5px h-20px" alt="">
                                                <span class="fw-600 alt-font text-dark-gray"><?php echo $OS_total_rooms; ?></span>
                                            </div>
                                            <span class="d-block lh-18 fs-15">Rooms</span> 
                                        </div>
                                    <div class="col">
                                            <div class="d-flex align-items-center">
                                                <img src="images/demo-real-estate-icon-chair-small.svg" class="me-5px h-20px" alt="">
                                                <span class="fw-600 alt-font text-dark-gray"><?php echo $OS_waiting_room; ?></span>
                                            </div>
                                            <span class="d-block lh-18 fs-15">Waiting Rooms</span> 
                                        </div>
                                    </div>
                                ...
                                <div class="row ps-35px pe-35px pt-20px pb-20px md-ps-25px md-pe-25px align-items-center">
                                    <div class="col">
                                        <a href="office-for-sale-details.php?id=<?php echo $OS_office_id; ?>" class="btn btn-dark-gray btn-very-small btn-round-edge fw-600">View details</a>
                                    </div>
                                    <div class="col text-end">
                                        <span class="fs-15 alt-font text-dark-gray fw-700 mb-0">Price : <?php echo $OS_price; ?></span>
                                    </div> 
                                </div> 
                            </div>
                        </div>
                    ...
                    <!-- start shop for sale box item -->
                    <div class="col mb-30px">
                        <div class="border-radius-6px overflow-hidden box-shadow-large">
                            <div class="image position-relative">
                                <a href="shop-for-sale-details.php?id=<?php echo $SS_shop_id; ?>">
                                    <img src="admin/<?php echo $SS_front_view; ?>" alt="">
                                </a>
                            ...
                            <div class="bg-white">
                                <div class="content ps-40px pe-40px pt-35px pb-35px md-p-25px border-bottom border-color-transparent-dark-very-light">
                                    <div class="d-flex align-items-center">
                                        <a href="shop-for-sale-details.php?id=<?php echo $SS_shop_id; ?>" class="alt-font text-dark-gray fw-700 fs-22 me-10px"><?php echo $SS_shop_name; ?></a>
                                    </div>
                                    <p class="mb-20px"><?php echo $SS_location; ?></p>
                                    <div class="row g-0">
                                        <div class="col">
                                            <div class="d-flex align-items-center">
                                                <img src="images/demo-real-estate-icon-bed-small.svg" class="me-5px h-20px" alt="">
                                                <span class="fw-600 alt-font text-dark-gray"><?php echo $SS_total_rooms; ?></span>
                                            </div>
                                            <span class="d-block lh-18 fs-15">Rooms</span> 
                                        </div>
                                        <div class="col">
                                            <div class="d-flex align-items-center">
                                                <img src="images/demo-real-estate-icon-bed-small.svg" class="me-5px h-20px" alt="">
                                                <span class="fw-600 alt-font text-dark-gray"><?php echo $SS_store_room; ?></span>
                                            </div>
                                            <span class="d-block lh-18 fs-15">Store</span> 
                                        </div>
                                        <div class="col">
                                        <span class="d-block lh-18 fs-15">Size</span> 
                                            <div class="d-flex align-items-center">
                                                <img src="images/demo-real-estate-icon-chair-small.svg" class="me-5px h-20px" alt="">
                                                <span class="fw-600 alt-font text-dark-gray"><?php echo $SS_measurement; ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div> 
                                <div class="row ps-35px pe-35px pt-20px pb-20px md-ps-25px md-pe-25px align-items-center">
                                    <div class="col">
                                        <a href="shop-for-sale-details.php?id=<?php echo $SS_shop_id; ?>" class="btn btn-dark-gray btn-very-small btn-round-edge fw-600">View details</a>
                                    </div>
                                    <div class="col text-end">
                                        <span class="fs-15 alt-font text-dark-gray fw-700 mb-0">Price : <?php echo $SS_price; ?></span>
                                    </div> 
                                </div> 
                            </div>
                        </div>
                    ...
                    <!-- start condominuim box item -->
                    <div class="col mb-30px">
                        <div class="border-radius-6px overflow-hidden box-shadow-large">
                            <div class="image position-relative">
                                <a href="condominium-for-sale-details.php?id=<?php echo $CS_condo_id; ?>">
                                    <img src="admin/<?php echo $CS_front_view; ?>" alt="" style="max-height: 260px;">
                                </a>
                            ...
                            <div class="bg-white">
                                <div class="content ps-40px pe-40px pt-35px pb-35px md-p-25px border-bottom border-color-transparent-dark-very-light">
                                    <div class="d-flex align-items-center">
                                        <a href="condominium-for-sale-details.php?id=<?php echo $CS_condo_id; ?>" class="alt-font text-dark-gray fw-700 fs-22 me-10px"><?php echo $CS_condo_name; ?></a>
                                    </div>
                                    <p class="mb-20px"><?php echo $CS_location; ?></p>
                                    <div class="row g-0">
                                        <div class="col">
                                            <div class="d-flex align-items-center">
                                                <img src="images/demo-real-estate-icon-bed-small.svg" class="me-5px h-20px" alt="">
                                                <span class="fw-600 alt-font text-dark-gray"><?php echo $CS_bedrooms; ?></span>
                                            </div>
                                            <span class="d-block lh-18 fs-15">Bedrooms</span> 
                                        </div>
                                        <div class="col">
                                            <div class="d-flex align-items-center">
                                                <img src="images/demo-real-estate-icon-bath-small.svg" class="me-5px h-20px" alt="">
                                                <span class="fw-600 alt-font text-dark-gray"><?php echo $CS_bathrooms; ?></span>
                                            </div>
                                            <span class="d-block lh-18 fs-15">Bathrooms</span> 
                                        </div>
                                        <div class="col">
                                            <div class="d-flex align-items-center">
                                                <img src="images/demo-real-estate-icon-size-small.svg" class="me-5px h-20px" alt="">
                                                <span class="fw-600 alt-font text-dark-gray"><?php echo $CS_living_area; ?><sup>2</sup></span>
                                            </div>
                                            <span class="d-block lh-18 fs-15">Living area</span> 
                                        </div>
                                    </div>
                                ...
                                <div class="row ps-35px pe-35px pt-20px pb-20px md-ps-25px md-pe-25px align-items-center">
                                    <div class="col">
                                        <a href="condominium-for-sale-details.php?id=<?php echo $CS_condo_id; ?>" class="btn btn-dark-gray btn-very-small btn-round-edge fw-600">View details</a>
                                    </div>
                                    <div class="col text-end">
                                        <span class="fs-15 alt-font text-dark-gray fw-700 mb-0">Price : <?php echo $CS_price; ?></span>
                                    </div> 
                                </div> 
                            </div>
                        </div>
